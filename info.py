...
API_ID = int(environ.get('API_ID', '21868557'))
API_HASH = environ.get('API_HASH', '91668a524679e0f0aa79faca1bdb1ca1')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6473376800').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002473595729'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002280552163').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002377739150')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://s47423513:<UUQXBUbeyuYgGdAU>@cluster0.4gux7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/animeTelugucreaterzz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/AnimetelugucreaterdiscussionChat') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/AnimeTeluguCreators')
